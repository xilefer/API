...
class group
{
    ...
    /**
     * Prüft ob die neue maximale Teilnehmerzahl gesetzt werden kann
     * Returncodes: 'Error'
     * @param $GroupID
     * @param $MaxMembers
     * @return int|string
    ...
    /**
     * Ändert die Accessibility einer Gruppe
    ...
    /**
     * Fügt einer Gruppe einen Benutzer hinzu
    ...
    /**
     * Gibt Details über eine Gruppe zurück.
     * Returncodes: 302; 303
     * @param $GroupID
     * @return array|int
     */
